...
class Pesificaciones extends CustomCActiveRecord
{
	...
	public function searchPesificacionesSinCompletar()
	{
        ...
        {
            $sql="SELECT SUM(cheques.montoOrigen) FROM cheques, detallePesificaciones, pesificaciones WHERE detallePesificaciones.chequeId=cheques.id AND detallePesificaciones.conceptoId = 1 AND detallePesificaciones.pesificacionId=pesificaciones.id AND pesificaciones.id='".$this->id."'";
