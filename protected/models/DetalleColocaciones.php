...
class DetalleColocaciones extends CActiveRecord {
    ...
    public function getDetalleColocaciones($idColocacion, $idCliente) {
        ...
        foreach ($detalleColocaciones as $detalleColocacion) {
            ...
            $valorActual = Colocaciones::model()->calculoValorActual($detalleColocacion->monto, $fechaFin, $detalleColocacion->tasa, $colocacion->getClearing());
            $html.="<td>" . Utilities::MoneyFormat($valorActual) . "</td>";
            $html.="<td>" . Utilities::MoneyFormat(Utilities::redondear_dos_decimal($detalleColocacion->monto)) . "</td>";
