...
class Sucursales extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre, comisionGeneral, tasaDescuentoGeneral, tasaInversores, tasaPesificacion, tasaPesificacionCorriente,diasClearing, userStamp, timeStamp, tasaPromedioPesificacion', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'tasaPesificacion' => 'Tasa Pesificacion Cheques Corrientes',
