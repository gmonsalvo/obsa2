...
class DetallePesificaciones extends CActiveRecord
{
    ...
    const TYPE_DEBITO = 1;
    public $fechaDesde, $fechaHasta,$pesificadorId,$tasaPesificacion;
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, pesificacionId, chequeId,pesificadorId,tasaPesificacion', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 */
	 public function search() {
        ...
        $criteria->with = array( 'pesificacion');
        $criteria->compare('pesificadorId', $this->pesificadorId);
        $criteria->compare('tasaPesificacion', $this->tasaPesificacion);
        $criteria->addBetweenCondition('fecha',$this->fechaDesde,$this->fechaHasta);
        $criteria->addCondition("tipoMov=1");
        $criteria->addCondition("conceptoId=1");
        $criteria->order="pesificadorId";
