...
<?php
$fechaIni=date("Y-m-d");
$fechaFin = strtotime ( '+7 day' , strtotime ( $fechaIni ) ) ;
...
$dataProvider = $cheques->searchChequesByEstadoByFecha(array(Cheques::TYPE_CORRIENTE, Cheques::TYPE_EN_CARTERA_COLOCADO),$chequesId,$fechaIni,$fechaFin); //tipo de cheque en cartera colocado
