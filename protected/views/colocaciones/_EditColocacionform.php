...
<div class="form">
    ...
    <table>
        <tr>
            <td><?php echo $form->labelEx($nuevoModel, 'fecha'); ?></td>
            <td><?php echo CHtml::label('Tasa', 'Colocaciones_tasa'); ?></td>
            <td style="display: none"><?php echo CHtml::label('Clearing', 'Colocaciones_clearing'); ?></td>
        </tr>
        <tr>
            <td><?php echo $form->textField($nuevoModel, 'fecha', array('readonly' => 'readonly', 'value' => date('d/m/Y'))); ?></td>
            <td><?php echo CHtml::textField('tasa', $originalModel->detalleColocaciones[0]->tasa, array("readonly" => "readonly","id"=>"Colocaciones_tasa", "onblur" =>"MostrarCheque()")); ?></td>
            <td style="display: none"><?php echo CHtml::textField('clearing', 0, array("readonly" => "readonly","id"=>"Colocaciones_clearing", "onblur" =>"MostrarCheque()")); ?></td>
    ...
    <style>
        ...
        <fieldset>
            ...
            <input type="text" name="diasColocados" id="diasColocados" readonly="readonly" value="<?php echo Utilities::RestarFechas3(date("d-m-Y"),Utilities::ViewDateFormat($originalModel->cheque->fechaPago)) + $originalModel->getClearing(); ?>" class="text ui-widget-content ui-corner-all" readonly="readonly" />
            <label for="montoValorActual">Monto valor actual:</label>
            <input type="text" name="montoValorActual" id="montoValorActual"  value="" onchange="calcularInversaValorActual(true)" class="text ui-widget-content ui-corner-all" />
