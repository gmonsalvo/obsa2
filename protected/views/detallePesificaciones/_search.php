...
<tr>    
<td class="row">
		<?php echo $form->label($model,'pesificadorId'); ?>
<?php echo CHtml::activeDropDownList($model,'pesificadorId',
		CHtml::listData(Pesificadores::model()->findAll(), 
		'id', 'denominacion'),array('empty'=>'Todos'));
	?>
</td>
<td class="row">
