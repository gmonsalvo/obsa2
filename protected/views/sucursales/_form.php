...
?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'tasaPesificacionCorriente'); ?>
		<?php echo $form->textField($model,'tasaPesificacionCorriente',array('size'=>3,'maxlength'=>6)); ?>
		<?php echo $form->error($model,'tasaPesificacionCorriente'); ?>
	</div>
