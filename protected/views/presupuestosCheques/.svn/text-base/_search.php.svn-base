...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'operacionChequeId'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'montoGastos'); ?>
		<?php echo $form->textField($model,'montoGastos',array('size'=>15,'maxlength'=>15)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'tieneNota'); ?>
		<?php echo $form->textField($model,'tieneNota'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'comisionado'); ?>
