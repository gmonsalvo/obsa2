<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('montoGastos')); ?>:</b>
	<?php echo CHtml::encode($data->montoGastos); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('tieneNota')); ?>:</b>
	<?php echo CHtml::encode($data->tieneNota); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('comisionado')); ?>:</b>
	<?php echo CHtml::encode($data->comisionado); ?>
	<br />
