...
<?php
        $this->beginWidget('zii.widgets.jui.CJuiDialog', array(
            ...
            'htmlOptions' => array('style' => 'font-size: 62.5%;height:476.133px; width: 450px !important'),
        ));
        ?>
        ...
        <fieldset>
        	<div id="form_detalle">
                ...
                //echo $this->renderPartial('/detallePesificaciones/_formUpdate', array( 'model' => new DetallePesificaciones(), 'pesificacionId'=>$_GET["pesificacionId"]), true);
                ?>
        		</div>
        </fieldset>
    </div>
